...
export default function SignInUp({ onClose }) {
    ...
    return (
        ...
        <div className="formOverlay fixed top-0 left-0 z-50 h-[100vh] w-[100vw] bg-black/75 flex justify-center items-center">
            <div className="bg-[var(--secondaryColor)] text-[var(--textColor)] relative rounded shadow-xl w-[25vw] min-h-[50vh] flex flex-col justify-center items-center text-center p-[1vh]">
                {/* Form */}
