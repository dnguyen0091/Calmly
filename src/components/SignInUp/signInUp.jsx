...
export default function SignInUp({ onClose }) {
    ...
    return (
        ...
        <div className="formOverlay fixed top-0 left-0 z-50 h-[100vh] w-[100vw] bg-black/75 flex justify-center items-center">
            <div className="bg-[var(--primaryColor)] relative rounded shadow-xl w-[25vw] min-h-[50vh] flex flex-col justify-center items-center text-center p-[1vh]">
                {/* Form */}
                <div className="form flex flex-col justify-center items-center">
                    ...
                    <div className="sliderContainer absolute top-0 flex flex-row justify-center gap-0 w-[10.5vw] mt-[3vh] border-black border-[0.1rem] rounded-4xl text-black">
                        <div className="formSlider absolute top-0 left-0 w-[50%] h-[100%] bg-[var(--backgroundColor)] rounded-4xl transition-[0.4s]"></div>
